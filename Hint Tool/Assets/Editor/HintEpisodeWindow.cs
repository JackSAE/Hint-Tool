...
public class HintEpisodeWindow : EditorWindow {
    ...
    {
        HintEpisodeWindow window = (HintEpisodeWindow)GetWindow(typeof(HintEpisodeWindow));
    ...
    void SaveAndAddHint()
    {
        ...
        dataPath += "hint/" + HintEpisodeWindow.hintInfo.hintName + ".asset";
        AssetDatabase.CreateAsset(HintEpisodeWindow.hintInfo, dataPath);

        newPrefabPath += "hints/" + HintEpisodeWindow.hintInfo.hintName + ".prefab";
        ...
        hintPrefab.GetComponent<HintClass>().hintData = HintEpisodeWindow.hintInfo;
        ...
        */
        ...
        GetWindow(typeof(HintEpisodeWindow)).Close(); //Closes window when its down? 
    }
}
